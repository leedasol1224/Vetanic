...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#1b352c] text-[#f2f7f4] pt-16 pb-12 mt-auto border-t border-brand-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-brand-800/80">
          {/* Col 1: Brand & Origin */}
          <div className="md:col-span-2 space-y-4">
            <div className="flex flex-col">
              ...
              <span className="text-xs text-brand-300 font-medium tracking-wide">
                Pet wellness from Korea, for companions everywhere.
              </span>
            </div>

            <div className="p-4 bg-brand-900/60 rounded-2xl border border-brand-700/50 max-w-lg">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full bg-brand-800 hover:bg-brand-700 flex items-center justify-center text-brand-100 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link to="/about" className="text-brand-100 hover:text-white transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/products" className="text-brand-100 hover:text-white transition-colors">
                  Our Products
                </Link>
              </li>
              <li>
                <Link to="/order" className="text-brand-100 hover:text-white transition-colors">
                  Order Request
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-brand-300/80 gap-4">
