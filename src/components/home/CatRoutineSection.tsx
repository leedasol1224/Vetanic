...
export const CatRoutineSection: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#FAF8F5] border-b border-brand-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand-100 text-brand-900 text-xs font-bold uppercase tracking-wider mb-2 border border-brand-200">
          ...
          <Link
            to="/products?pet=cat"
            className="inline-flex items-center gap-2 bg-brand-800 hover:bg-brand-900 text-white font-bold text-xs px-5 py-2.5 rounded-xl shadow-sm transition-all mt-4 md:mt-0"
          >
