...
export const LaunchPromoSection: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-b from-[#F5EFE6]/70 via-white to-[#FAF8F5] border-b border-brand-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-brand-200/80 shadow-soft-lg relative overflow-hidden">
          {/* Decorative badge */}
          <div className="absolute top-0 right-0 transform translate-x-8 -translate-y-8 w-40 h-40 bg-amber-100/60 rounded-full blur-2xl -z-0 pointer-events-none" />

          <div className="max-w-3xl mx-auto text-center space-y-4 mb-10 relative z-10">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-amber-100 text-amber-950 text-xs font-bold uppercase tracking-wider border border-amber-200">
              <Sparkles className="w-3.5 h-3.5 text-amber-700" />
              <span>September 2026 Exclusive</span>
            </div>

            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-charcoal tracking-tight">
              Celebrate Our Singapore Launch
            </h2>

            <p className="text-sm sm:text-base text-charcoal leading-relaxed font-normal">
              VETANIC is now available in Singapore. Enjoy special launch prices throughout September and save more when you mix & match your everyday pet wellness essentials.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10 relative z-10">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-2 mt-3 mb-4">
                  <span className="text-2xl font-bold text-brand-900 font-serif">
                    SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierA.launchPrice.toFixed(2)}
                  </span>
                  <span className="text-xs text-charcoal-muted line-through">
                    SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierA.regularPrice.toFixed(2)}
                  </span>
                ...
                <div className="space-y-2 pt-3 border-t border-brand-200/60 text-xs text-charcoal">
                  <div className="flex items-center gap-2">
                    ...
                    <span><strong>Any 2 Tier A:</strong> SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierA.bundle2Price.toFixed(2)}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-brand-600 flex-shrink-0" />
                    <span><strong>Any 3 Tier A:</strong> SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierA.bundle3Price.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#FAF8F5] rounded-2xl p-6 border border-brand-200/90 flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-baseline gap-2 mt-3 mb-4">
                  <span className="text-2xl font-bold text-brand-900 font-serif">
                    SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierB.launchPrice.toFixed(2)}
                  </span>
                  <span className="text-xs text-charcoal-muted line-through">
                    SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierB.regularPrice.toFixed(2)}
                  </span>
                  <span className="text-[10px] font-bold text-amber-900 bg-amber-100 px-2 py-0.5 rounded-md">
                    Launch Price
                  </span>
                ...
                <div className="space-y-2 pt-3 border-t border-brand-200/60 text-xs text-charcoal">
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-brand-600 flex-shrink-0" />
                    <span><strong>Any 2 Tier B:</strong> SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierB.bundle2Price.toFixed(2)}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-brand-600 flex-shrink-0" />
                    <span><strong>Any 3 Tier B:</strong> SGD {SEPTEMBER_2026_LAUNCH_PROMOTION.tierB.bundle3Price.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
